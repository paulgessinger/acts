...
class NavigationLayer : public Layer {
 public:
  ...
  static LayerPtr create(ConstSurfacePtr sRepresentation,
                         double thickness = 0.) {
 ...
 protected:
  ...
  NavigationLayer(ConstSurfacePtr surfaceRepresentation, double thickness);
  ...
  ///
  ConstSurfacePtr m_surfaceRepresentation;
};
