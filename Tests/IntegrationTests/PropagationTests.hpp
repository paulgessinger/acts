...
struct ZCylinderSurfaceBuilder {
  template <typename charge_t>
  Acts::AsymHandle<Acts::CylinderSurface> operator()(
      const Acts::SingleBoundTrackParameters<charge_t>& params,
      const Acts::GeometryContext& geoCtx) {
...
struct DiscSurfaceBuilder {
  template <typename charge_t>
  Acts::AsymHandle<Acts::DiscSurface> operator()(
      const Acts::SingleBoundTrackParameters<charge_t>& params,
      const Acts::GeometryContext& geoCtx) {
    using namespace Acts;
    using namespace Acts::UnitLiterals;
...
struct PlaneSurfaceBuilder {
  template <typename charge_t>
  Acts::AsymHandle<Acts::PlaneSurface> operator()(
      const Acts::SingleBoundTrackParameters<charge_t>& params,
      const Acts::GeometryContext& geoCtx) {
...
struct ZStrawSurfaceBuilder {
  template <typename charge_t>
  Acts::AsymHandle<Acts::StrawSurface> operator()(
      const Acts::SingleBoundTrackParameters<charge_t>& params,
      const Acts::GeometryContext& geoCtx) {
